...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    // when springboot starts, save these recipes
    @Override
    @Transactional
    ...
    // create and return list of repositories
    private List<Recipe> getRecipes() {

    	// array for the two recipes we are going to add
        ...
        // init these sets in recipe class first to avoid null pointer exception
